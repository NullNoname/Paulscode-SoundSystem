...
public class PAudioFormat {
     ...
     *                                                  means little-endian)
     */
    public PAudioFormat(Encoding encoding, float sampleRate, int sampleSizeInBits,
     ...
     * @since 1.5
     */
    public PAudioFormat(Encoding encoding, float sampleRate,
     ...
     *                                                  means little-endian)
     */
    public PAudioFormat(float sampleRate, int sampleSizeInBits,
     ...
     *
     * @see #getFrameRate()
     * @see PAudioFormat#NOT_SPECIFIED
     */
    ...
    public boolean matches(PAudioFormat format) {
        ...
        if (format.getEncoding().equals(getEncoding()) &&
            ( (format.getSampleRate() == NOT_SPECIFIED) || (format.getSampleRate() == getSampleRate()) ) &&
            (format.getSampleSizeInBits() == getSampleSizeInBits()) &&
            (format.getChannels() == getChannels() &&
             (format.getFrameSize() == getFrameSize()) &&
             ( (format.getFrameRate() == NOT_SPECIFIED) || (format.getFrameRate() == getFrameRate()) ) &&

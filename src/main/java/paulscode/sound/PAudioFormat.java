...
/**
 * <code>PAudioFormat</code> is a clone of Java Sound's <code>AudioFormat</code>,
 ...
 * <p>
 * This code was copy-pasted and modified from Apache Harmony.
 * <a href="https://github.com/apache/harmony/blob/java6/classlib/modules/sound/src/main/java/javax/sound/sampled/AudioSystem.java">(Original Code)</a>
 * <p>
 * The "NOT_SPECIFIED" constant was copied from <code>AudioSystem</code> from the same codebase.
 * <p>
 * License is <a href="http://www.apache.org/licenses/LICENSE-2.0">Apache License Version 2.0</a>.
 */
public class PAudioFormat {
    ...
    public PAudioFormat(PAudioFormat.Encoding encoding,
            float sampleRate,
    ...
    public PAudioFormat(float sampleRate,
            int sampleSizeInBits,
            int channels,
            boolean signed,
            boolean bigEndian) {
    ...
    public boolean matches(PAudioFormat format) {

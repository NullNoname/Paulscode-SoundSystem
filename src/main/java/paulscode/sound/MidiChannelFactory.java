...
/**
 * MidiChannelFactory provides an interface of IMidiChannel factory.
 *<br><br>
...
public interface MidiChannelFactory {
	/**
	 * Creates a new MIDI player instance that implements IMidiChannel.
	 ...
	 * @return A MIDI channel instance
	 */
